...
<template>
  <div class="project-detail">
    <NuxtLink :href="`https://github.com/${repo.repo.repo}`" class="project-gh">Check out<strong>{{ repo.repo.name }}</strong> on Github <GithubLogo /> &mdash; <Star />stars {{ formatStarCount(repo.repo.stars) }} </NuxtLink>
